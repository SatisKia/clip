...
window._CHAR_CODE_1 = _CHAR_CODE_1;
window._CHAR_CODE_2 = _CHAR_CODE_2;
window._CHAR_CODE_3 = _CHAR_CODE_3;
window._CHAR_CODE_4 = _CHAR_CODE_4;
window._CHAR_CODE_5 = _CHAR_CODE_5;
window._CHAR_CODE_6 = _CHAR_CODE_6;
window._CHAR_CODE_7 = _CHAR_CODE_7;
...
window._CLIP_CODE_SEPARATOR = 20;
window._CLIP_CODE_COMMENT = 21;
window._CLIP_CODE_PARAM_ANS = 22;
window._CLIP_CODE_PARAM_ARRAY = 23;
window._CLIP_CODE_SE = 24;
...
window._CLIP_SE_MUL = 8;
window._CLIP_SE_DIV = 9;
window._CLIP_SE_MOD = 10;
window._CLIP_SE_ADD = 11;
window._CLIP_SE_SUB = 12;
window._CLIP_SE_POW = 13;
window._CLIP_SE_SHIFTL = 14;
window._CLIP_SE_SHIFTR = 15;
window._CLIP_SE_AND = 16;
window._CLIP_SE_OR = 17;
window._CLIP_SE_XOR = 18;
window._CLIP_SE_LESS = 19;
window._CLIP_SE_LESSOREQ = 20;
window._CLIP_SE_GREAT = 21;
window._CLIP_SE_GREATOREQ = 22;
window._CLIP_SE_EQUAL = 23;
window._CLIP_SE_NOTEQUAL = 24;
window._CLIP_SE_LOGAND = 25;
window._CLIP_SE_LOGOR = 26;
window._CLIP_SE_MUL_A = 27;
window._CLIP_SE_DIV_A = 28;
window._CLIP_SE_MOD_A = 29;
window._CLIP_SE_ADD_A = 30;
window._CLIP_SE_SUB_A = 31;
window._CLIP_SE_POW_A = 32;
window._CLIP_SE_SHIFTL_A = 33;
window._CLIP_SE_SHIFTR_A = 34;
window._CLIP_SE_AND_A = 35;
window._CLIP_SE_OR_A = 36;
window._CLIP_SE_XOR_A = 37;
window._CLIP_SE_LESS_A = 38;
window._CLIP_SE_LESSOREQ_A = 39;
window._CLIP_SE_GREAT_A = 40;
window._CLIP_SE_GREATOREQ_A = 41;
window._CLIP_SE_EQUAL_A = 42;
window._CLIP_SE_NOTEQUAL_A = 43;
window._CLIP_SE_LOGAND_A = 44;
window._CLIP_SE_LOGOR_A = 45;
window._CLIP_SE_CONDITIONAL = 46;
window._CLIP_SE_SET_FALSE = 47;
window._CLIP_SE_SET_TRUE = 48;
window._CLIP_SE_SET_ZERO = 49;
window._CLIP_SE_LOOPSTART = 50;
window._CLIP_SE_LOOPEND = 51;
window._CLIP_SE_LOOPEND_INC = 52;
window._CLIP_SE_LOOPEND_DEC = 53;
window._CLIP_SE_LOOPENDEQ = 54;
window._CLIP_SE_LOOPENDEQ_INC = 55;
window._CLIP_SE_LOOPENDEQ_DEC = 56;
window._CLIP_SE_CONTINUE = 57;
window._CLIP_SE_BREAK = 58;
window._CLIP_SE_RETURN = 59;
window._CLIP_SE_RETURN_ANS = 60;
window._CLIP_SE_FUNC = 61;
