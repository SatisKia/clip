...
function dft( ret , ret_num, src , src_start, src_num ){
...
function idft( ret , ret_start, ret_num, src , src_num ){
 var T = 6.28318530717958647692 / ret_num;
 var x, t, U, V;
 var tmp;
...
function conv( ret , ret_start, ret_num, x , x_start, x_num, y , y_start, y_num ){
 var X = new Array();
 var Y = new Array();
